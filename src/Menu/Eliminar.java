...
public class Eliminar extends javax.swing.JFrame {
    ...
    public Eliminar() {
        eliminarvehiculo = new DefaultTableModel(null, getColumnas());
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-search.png"))); // NOI18N
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 290, 90, 20));

        jTable1.setModel(eliminarvehiculo);
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 40, 410, 240));
