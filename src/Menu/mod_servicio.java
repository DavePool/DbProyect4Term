...
public class mod_servicio extends javax.swing.JFrame {
    ...
    private String [] getColumnas(){
        String columna []= new String []{"ID","No_Motor","15milkm","30milkm","45milkm","60milkm"};
    ...
    private void setFilas(){
        try{
            ...
            ResultSet rst=acb.modiservicio();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(tablaservicio);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField2.setText(String.valueOf(jTable1.getValueAt(seleccion, 3)));
        ...
        jTextField6.setText(String.valueOf(jTable1.getValueAt(seleccion, 1)));
    }//GEN-LAST:event_jTable1MouseClicked

    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        jLabel2.setText(acb.conexioBD());
        setFilas();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mod_servicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mod_servicio().setVisible(true);
            }
        });
    }
