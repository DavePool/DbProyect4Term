...
public class con_servicio extends javax.swing.JFrame {

    acciones_BD abd = new acciones_BD();
    DefaultTableModel modelotabla3;
    public con_servicio() {
        modelotabla3 = new DefaultTableModel(null, getColumnas());
        initComponents();
        this.setLocationRelativeTo(null);
    }

    private String [] getColumnas(){
        String columna []= new String []{"Nombre","15milkm","30milkm","45milkm","60milkm"};
    ...
    private void setFilas(){
        try{
            ...
            ResultSet rst=abd.llenarTabla3();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(con_servicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new con_servicio().setVisible(true);
            }
        });
    }
